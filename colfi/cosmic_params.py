...
def params_dict_zoo():
    ...
    The labels are used to plot figures. 
    The physical limits are used to ensure the simulated parameters have physical meaning.
    
    Note
    ----
    If the physical limits of parameters is unknown or there is no physical limits, it should be set to np.nan.
    """
    return {'H0'     : [r'$H_0$', 0, np.nan], #the Hubble constant
